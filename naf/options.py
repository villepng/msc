...
class Options:
    def __init__(self):
        ...
        self.room_sizes = {'test_1': '10.0x6.0x2.5', 'test_2': '4.0x5.75x2.5', 'test_3': '6.0x6.0x3.0'}
    ...
    def initialize(self):
        parser = self.parser
        parser.add_argument('--apt', default='test_1', choices=['test_1', 'test_2', 'test_3'], type=str)
    ...
    def parse(self):
        ...
        self.opt.max_len = {'test_1': 84, 'test_2': 47, 'test_3': 66}  # Calculated when generating the dataset, 45 with fft_size 512
