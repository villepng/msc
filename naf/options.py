...
class Options():
    ...
    def initialize(self):
        ...
        parser.add_argument('--apt', default='apartment_1', choices=['test_1', 'apartment_1', 'apartment_2', 'frl_apartment_2', 'frl_apartment_4', 'office_4', 'room_2'], type=str)
        ...
        parser.add_argument('--spec_base', default="./metadata_mono/magnitudes", type=str)  # Location of the actual training spectrograms
        parser.add_argument('--mean_std_base', default="./metadata_mono/mean_std", type=str)  # Location of sound mean_std data
        parser.add_argument('--minmax_base', default="./metadata_mono/minmax", type=str)  # Location of room bbox data
        ...
        parser.add_argument('--split_loc', default="./metadata_mono/train_test_split/", type=str) # Where the train test split is stored
        ...
        parser.add_argument('--emitter_loc', default=[1.0, 1.0], type=list_float_flag)  # Where do we position the emitter? [0.5, -3.0] for apartment_1, [-0.2, 0.0] for apartment_2
    ...
    def parse(self):
        ...
        self.opt.max_len = {"test_1": 28, "apartment_1": 101, "apartment_2": 86, "frl_apartment_2": 107,
                            "frl_apartment_4": 103, "office_4": 78, "room_2": 84}
